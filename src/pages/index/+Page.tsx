      ...
      <main class="flex-grow">
        <section id="contact-me" class="container mx-auto max-w-2xl scroll-mt-10 px-4 py-12 md:py-16">
          <div class="mb-8 text-center">
            <h2 class="mb-2 text-sm font-bold tracking-[0.25em] text-primary">Contact rtritto from</h2>
            <div>
              <a
                href="https://github.com/rtritto"
                target="_blank"
                rel="noopener noreferrer"
                class="btn gap-2 shadow-sm transition-transform btn-neutral btn-sm hover:-translate-y-0.5 md:btn-md"
